...
@Ignore
public class ServicesDeleteHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ServicesDeleteHandlerTest.class);
    ...
    @Test
    public void testServicesDeleteHandlerTest() throws ClientException {
        ...
        String requestUri = "/services?serviceId=bMjrOih&tag=AtCwNclAHoljLOsl&address=agIlNnqzbnm&port=55";
