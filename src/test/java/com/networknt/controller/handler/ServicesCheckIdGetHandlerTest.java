...
@Ignore
public class ServicesCheckIdGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ServicesCheckIdGetHandlerTest.class);
    ...
    @Test
    public void testServicesCheckIdGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/services/check/JZzjroFwCBphON";
