...
@Ignore
public class ServicesLoggerContentPostHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ServicesLoggerContentPostHandlerTest.class);
    ...
    @Test
    public void testServicesLoggerContentPostHandlerTest() throws ClientException {
        ...
        String requestUri = "/services/logger/content";
    ...
    public void testDateTimeConvert() {
        String s = "2022-02-04T02:45";
        LocalDateTime startDateTime = LocalDateTime.parse(s);
