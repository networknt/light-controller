...
@Ignore
public class ServicesFailCheckIdPutHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ServicesFailCheckIdPutHandlerTest.class);
    ...
    @Test
    public void testServicesFailCheckIdPutHandlerTest() throws ClientException {
        ...
        String requestUri = "/services/fail/Ekrlp";
