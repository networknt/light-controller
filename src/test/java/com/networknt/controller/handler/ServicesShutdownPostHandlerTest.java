...
@Ignore
public class ServicesShutdownPostHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ServicesShutdownPostHandlerTest.class);
    ...
    @Test
    public void testServicesShutdownPostHandlerTest() throws ClientException {
        ...
        String requestUri = "/services/shutdown";
