...
@Ignore
public class ServicesLookupGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ServicesLookupGetHandlerTest.class);
    ...
    @Test
    public void testServicesLookupGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/services/lookup?serviceId=uOxHMTgWLaKiWVF&passing=false&tag=BvAUwYIdVLAX";
