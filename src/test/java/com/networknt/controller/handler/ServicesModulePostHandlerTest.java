...
@Ignore
public class ServicesModulePostHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ServicesModulePostHandlerTest.class);
    ...
    @Test
    public void testServicesModulePostHandlerTest() throws ClientException {
        ...
        String requestUri = "/services/module";
