...
@Ignore
public class ServicesCheckGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ServicesCheckGetHandlerTest.class);
    ...
    @Test
    public void testServicesCheckGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/services/check?local=false";
