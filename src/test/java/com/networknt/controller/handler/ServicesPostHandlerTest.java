...
@Ignore
public class ServicesPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ServicesPostHandlerTest.class);
    ...
    @Test
    public void testServicesPostHandlerTest() throws ClientException {
