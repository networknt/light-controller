...
@Ignore
public class ServicesLoggerPostHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ServicesLoggerPostHandlerTest.class);
    ...
    @Test
    public void testServicesLoggerPostHandlerTest() throws ClientException {
        ...
        String requestUri = "/services/logger";
