...
@Ignore
public class ServicesLoggerGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ServicesLoggerGetHandlerTest.class);
    ...
    @Test
    public void testServicesLoggerGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/services/logger?protocol=IKoRrxWp&address=zdORETCCJGZTxAML&port=70";
