...
@Ignore
public class ServicesModuleGetHandlerTest {

    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ServicesModuleGetHandlerTest.class);
    ...
    @Test
    public void testServicesModuleGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/services/module?protocol=mZADhKQBmTRkyxJvEYxdwLbdY&address=WlFAbEgasgev&port=11";
