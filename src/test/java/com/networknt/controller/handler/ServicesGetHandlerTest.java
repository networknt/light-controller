...
@Ignore
public class ServicesGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(ServicesGetHandlerTest.class);
    ...
    @Test
    public void testServicesGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/services?serviceId=pZzYuihUVaotrsOjfQAADGXkEa&passing=true&tag=XgUiAJxTnPzkplPPMfKNplEz&wait=VzkqAVvug&index=46";
